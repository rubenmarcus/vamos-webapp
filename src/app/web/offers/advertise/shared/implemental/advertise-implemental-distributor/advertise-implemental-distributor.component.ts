...
@Component({ preserveWhitespaces: false,
  selector: 'app-advertise-implemental-distributor',
  templateUrl: './advertise-implemental-distributor.component.html',
  styleUrls: ['./advertise-implemental-distributor.component.scss']
})
export class AdvertiseImplementalDistributorComponent implements OnInit {
  ...
  ngOnInit() {
    this.setValidators();
    this.setYear();
    this.advertiseForm.get('implement').get('type').setValue('distributor');
  }
  ...
  setValidators(){
    ...
    this.advertiseForm.get('implement').get('width_distribution').setValidators([Validators.required]);
    this.advertiseForm.get('implement').get('capacity').setValidators([Validators.required]);
