...
@Component({ preserveWhitespaces: false,
  selector: 'app-advertise-implemental-trimmer',
  templateUrl: './advertise-implemental-trimmer.component.html',
  styleUrls: ['./advertise-implemental-trimmer.component.scss']
})
export class AdvertiseImplementalTrimmerComponent implements OnInit {
  ...
  ngOnInit() {
    this.setValidators();
    this.setYear();
    this.advertiseForm.get('implement').get('type').setValue('trimmer');
  }
  ...
  setValidators() {
    ...
    this.advertiseForm.get('implement').get('knife_rotation').setValidators([Validators.required]);
    this.advertiseForm.get('implement').get('cutting_width').setValidators([Validators.required]);
    this.advertiseForm.get('implement').get('cutting_height').setValidators([Validators.required]);
    this.advertiseForm.get('implement').get('width_transport').setValidators([Validators.required]);
  }
