...
@Component({ preserveWhitespaces: false,
  selector: 'app-advertise-implemental-planer',
  templateUrl: './advertise-implemental-planer.component.html',
  styleUrls: ['./advertise-implemental-planer.component.scss']
})
export class AdvertiseImplementalPlanerComponent implements OnInit {
  ...
  ngOnInit() {
    this.setValidators();
    this.setYear();
    this.advertiseForm.get('implement').get('type').setValue('planer');
  }
